...
class ClearAllLifeLogsUseCase @Inject constructor(
    private val repository: LifeLogWriteRepository,
) : SuspendUseCase<NoParams, Unit>() {
    override suspend fun execute(params: NoParams) = repository.clearAllLifeLogs()
}
