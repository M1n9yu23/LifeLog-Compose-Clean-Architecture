...
class SetLanguageConfigUseCase @Inject constructor(
    private val languageRepository: LanguageRepository,
) : SuspendUseCase<LanguageConfig, Unit>() {
    override suspend fun execute(params: LanguageConfig) = languageRepository.setLanguageConfig(params)
}
